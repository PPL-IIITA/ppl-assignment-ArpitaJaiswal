...
public class gift {
     ...
     * <p> Save Output gifting_q6.xls at Document Folder of C:/ Drive
    ...
    try {
        try {
            ...
            workbook3 = jxl.Workbook.getWorkbook(new File(doc+"\\couplesnew_q6.xls"));
    ...
    FileOutputStream out2 = new FileOutputStream(doc+"\\gifting_q6.xls");
    wb.write(out2);
    out2.close();
    }
