...
public class geek_gift extends gift{
   public void gifting(Extract e, int j, int k){
    ...
    /*public void giftI(int c, int budget, Row row, Cell  cell, Vector v){
        int b = budget;
        int m = 0;
        //v = new Vector();
                int miser_flag = 0;
