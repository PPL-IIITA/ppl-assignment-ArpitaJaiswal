...
public class Valentine1 {
     ...
     */
    public void fillData(File file1, File file2, int u) throws BiffException, FileNotFoundException, IOException{
    ...
    try {
        ...
        for (int o = 1; o < u; o++) {
            int j = rand.nextInt(sheet1.getRows()-1)+1;
            Vector d = new Vector();
            k = 0;
            int match = 0;
   ...
   public void open(int u) throws BiffException, IOException{
