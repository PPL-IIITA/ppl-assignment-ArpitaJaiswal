...
public class gift {
    ...
    miser_gift mg = new miser_gift();
    mg.cal();
        geek_gift gg = new geek_gift();
        mg.cal();
        generous_gift ggg = new generous_gift();
        mg.cal();
            ...
            if(found==1){
                ...
                switch(st){
                    case "Miser":
                        ...
                        if(c<0)
                            c = 0;
                        mg.giftI(c,budget,row,cell);
                        break;
                    case "Geek":
                        c = budget-v1;
                        if(c<0)
                            c = 0;
                        gg.giftI(c,budget,row,cell);
                        break;
                    case "Generous":
                        c = 0;
                        gg.giftI(c,budget,row,cell);
                ...
                //System.out.println("vt  "+vt.size());
                cell = row.createCell(2);
                //cell.setCellValue((int)vt.elementAt(0));
                cell = row.createCell(3);
               // cell.setCellValue((int)vt.elementAt(1));
                cell = row.createCell(7);
               // cell.setCellValue((int)vt.elementAt(2));
            }
    ...
    FileOutputStream out2 = new FileOutputStream(doc+"\\gifting3.xls");
    wb.write(out2);
    out2.close();
    }
    ...
    public jxl.Cell cell1, cell2, cell3, cell4;
    public Row row;
    public Cell cell;
    public Vector vt;
}