 ...
 */
public class generous_gift extends happ_comp{
    /**
     * perform gifting by generous.
     * @param c
     * c is maintenence of girl.
     * @param budget
     * budget is budget of generous boy.
     * @param rows
     * @throws IOException
     * @throws BiffException 
     */
    public void giftI(int c, int budget, Row rows) throws IOException, BiffException{
        g.jio();
