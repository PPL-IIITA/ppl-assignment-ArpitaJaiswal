...
/**
 * <h> Perform the gifting operation by boy according to nature of boy and maintenance budget of girl and one gift of each type is also the criteria </h>
 * it inherits the class GiftSelector.
 * Implement all variants via inheritance and use upcasting to the base class
 * @author ARPITA AYUSHI
 */
public class gift_one extends GiftSelector{
    /**
                ...
                while(budget>c && counts>0){
                    ...
                    for(l=1;l<sheet4.getRows();l++){
                      ...
                      Integer val = new Integer(Integer.parseInt(cell4.getContents().toString()));
                       ...
                       // System.out.println(cell4.getContents()+" "+counts+"");
                        }
                        if(counts==2 && cell4.getContents().equals("Essential")){
                            //System.out.println(cell4.getContents());
                      cell4 = sheet4.getCell(2, l);
                      g_val = new Integer(Integer.parseInt(cell4.getContents().toString()));
                      cell4 = sheet4.getCell(3, l);
                      Integer val = new Integer(Integer.parseInt(cell4.getContents().toString()));
                        ...
                        if(counts==1 && cell4.getContents().equals("Utility")){
                            //System.out.println(cell4.getContents());
                      cell4 = sheet4.getCell(2, l);
                      g_val = new Integer(Integer.parseInt(cell4.getContents().toString()));
                      cell4 = sheet4.getCell(3, l);
