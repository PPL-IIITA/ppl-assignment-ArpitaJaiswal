...
public class gift {
     ...
     * @param ss to extract information of couple from .xls file (q5_couples_using_q1.xls or q5_couples_using_q4.xls)
     * <p> Save Output gifting4.xls at Document Folder of C:/ Drive
     * @throws FileNotFoundException
     * @throws IOException 
     */

    public void gifting(String ss) throws FileNotFoundException, IOException{
    ...
    try {
        try {
            ...
            workbook3 = jxl.Workbook.getWorkbook(new File(doc+ss));
    ...
    FileOutputStream out2 = new FileOutputStream(doc+"\\gifting4.xls");
    wb.write(out2);
    out2.close();
    }
