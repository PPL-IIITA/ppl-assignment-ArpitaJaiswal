...
public class couple1 {
    /**
     * save the q5_couples_using_q1.xlss file in Document folder
     * @throws BiffException
     * @throws FileNotFoundException
     * @throws IOException 
     */
    public void couple_formed( ) throws BiffException, FileNotFoundException, IOException{
   ...
   // JFileChooser jChooser = new JFileChooser();
    ...
    //String doc = (jChooser.getFileSystemView().getDefaultDirectory().toString());
    FileOutputStream out = new FileOutputStream(doc+"\\q5_couples_using_q1.xls");
    wb.write(out);
    out.close();
    }
    private Vector data,girls,boys;
