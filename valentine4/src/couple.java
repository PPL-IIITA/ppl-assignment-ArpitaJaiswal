...
public class couple {
     ...
     * save output couplesnew.xls in Document folder of C:/Drive.
     ...
     * @throws IOException 
     */
    public void newcouple(extract e) throws BiffException, FileNotFoundException, IOException{
   ...
   // JFileChooser jChooser = new JFileChooser();
    ...
    //String doc = (jChooser.getFileSystemView().getDefaultDirectory().toString());
    FileOutputStream out = new FileOutputStream(doc+"\\couplesnew.xls");
    wb.write(out);
    out.close();
    }
    private Vector data;
